...
const Signup = () => {
  ...
  const [passHideStatus, setPassHideStatus] = useState(true)
    ...
    <div className="bg-blue-950 h-[100vh] flex">
      ...
      >
        ...
        <input
          ...
          required
        />
        <div className="border rounded w-full mb-4 flex justify-between">
          <input
            type={passHideStatus ? "password" : "text"}
